...
/*:: type CacheUtilType = rec u . {AnObject with
  ...
  setPref : [this('u)] Any -> Undef,
  clearCacheByRange : [this('u)] Array<Num> -> Undef,
  savePrefFile : [this('u)] -> Undef,
  }; */
...
textareaCacheUtil = {
    ...
    // ** PASSES **
    setPref : /*:[this(CacheUtilType)] Any -> Undef*/ function (aCache) {
    ...
    // ** PASSES **
    savePrefFile : /*: cheat [CacheUtilType] -> Undef */ function () {
...
textareaCache = {
    ...
    writeToPref : /*: [tacType] aNode -> Undef */ function (node) {
        this.prefToCache();
