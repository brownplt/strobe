...
type constructor CacheObjConstructor = {[CacheObjInst] nsIDOMHTMLTextAreaElement -> CacheObjInst with
  get : [CacheObjConstructor] (nsIDOMHTMLTextAreaElement + Str) -> CacheObjInst,
  make : [CacheObjConstructor] (nsIDOMHTMLTextAreaElement + Str) * (Bool + Undef) -> CacheObjInst,
}
and prototype CacheObj = {AnObject with
  addGumDrop : [CacheObjInst] -> Undef,
  ...
  hitched_keypress : [CacheObjInst] nsIDOMKeyEvent -> Bool,
  initFromExistingFile : [CacheObjInst] -> Undef,
  keypress : [Any] nsIDOMKeyEvent -> (Bool + Undef),
  onContext : [CacheObjInst] nsIDOMEvent -> Bool,
  read : [CacheObjInst] -> Str,
  setExtension : [CacheObjInst] Str -> Undef,
...
and instance CacheObjInst = {Ext with
  ...
  mouseover : [CacheObjInst] nsIDOMEvent -> Undef,
...
and prototype Monitor = {AnObject with
  ...
  destroy : [Any] -> Undef,
  restart : [Any] -> Undef,
  hitched_registerPage : [MonitorInst] nsIDOMEvent -> Undef,
  registerPage : [this(Any)] nsIDOMEvent -> Undef,
  ...
  hitched_watcher : [MonitorInst] Ext * Bool -> Undef,
  watcher : ([Any] Num * Bool -> Undef),
  ...
  hitched_handleSubtreeModified : [MonitorInst] nsIDOMEvent -> Undef,
  handleSubtreeModified : [Any] nsIDOMEvent -> Undef,
  hitched_startPage : [MonitorInst] mockEvent * (Bool + Undef)-> Undef,
  startPage : [this(Any)] mockEvent *(Bool + Undef)-> Undef,
...
and prototype ItsAllText = {AnObject with
  ...
  cleanEditDir : [iatInstance] (Bool + Undef) -> Undef,
  menuNewExtEdit : [iatInstance] nsIDOMEvent -> Undef,
  menuExtEdit : [iatInstance] Str * Bool * nsIDOMEvent -> Undef,
  rebuildMenu : [iatInstance] Str * (Str + Undef) * (Bool + Undef) -> nsIDOMNode,
...
and instance iatInstance = {Ext with
  ...
  getTrackerId : [iatInstance] -> Str,
  isDarwin : [iatInstance] -> Bool,
  getEditor : [iatInstance] -> nsILocalFile,
  ...
  appendExtensions : [iatInstance] Str -> Undef,
  getFromTracker : [iatInstance] realisticStr -> CacheObjInst,
  addToTracker : [iatInstance] realisticStr * CacheObjInst -> Undef,
  ...
  onEditNode : [iatInstance] nsIDOMHTMLTextAreaElement -> Undef,
  onContextMenu : [iatInstance] nsIDOMEvent -> Bool,
...
var ItsAllText = /*: ItsAllTextConstructor */ function () {
    ...
    that.getTrackerId = /* [iatInstance] -> Str */ function () {
...
ItsAllText.prototype.init = /*:[iatInstance] -> Undef*/function () {
    /**
 ...
 */
ItsAllText.prototype.cleanEditDir = /*: [iatInstance] (Bool + Undef) -> Undef */ function (force) {
    var e = /*:Ext*/null;
...
ItsAllText.prototype.menuNewExtEdit = /*:[iatInstance] nsIDOMEvent -> Undef*/ function (event) {
    var that = this,
...
function(event) { itsalltext.onEditNode(/*: cheat nsIDOMHTMLTextAreaElement */(document.popupNode)); };
/*: nsIDOMEvent -> Undef*/function(event) { itsalltext.menuNewExtEdit(event); };
/*: nsIDOMEvent -> Undef*/function(event) { itsalltext.menuExtEdit('.txt', false, event); };
function(event) { itsalltext.openReadme(); };
function(event) { itsalltext.openPreferences(); };
/*: nsIDOMEvent -> Undef*/function(event) { itsalltext.menuNewExtEdit(event); };
/*: nsIDOMEvent -> Undef*/function(event) { itsalltext.menuExtEdit('.txt', false, event); }; // NEAL: PARAMETERS IN WRONG ORDER
function(event) { itsalltext.openReadme(); };
function(event) { itsalltext.openPreferences(); };
function(event) { itsalltext.openReadme(); };
function(event) { itsalltext.openPreferences(); };
 ...
 */
Monitor.prototype.hitched_registerPage = /*: [MonitorInst] nsIDOMEvent -> Undef */function (event) {
...
Monitor.prototype.hitched_handleSubtreeModified = /*: [MonitorInst] nsIDOMEvent -> Undef */ function (event) {
...
var CacheObj = /*: Constructing<CacheObjConstructor> */ function (node) {
    ...
    itsalltext.addToTracker(/*: cheat realisticStr */(that.uid), that);
